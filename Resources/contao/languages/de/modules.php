...
// Content-Element-Label im Backend (Artikel → Element hinzufügen → Typ)
$GLOBALS['TL_LANG']['CTE']['venne_search'] = ['Venne Search', 'Suchfeld direkt im Artikel — kein Frontend-Modul-Setup nötig.'];

// Legend für die Modul-Konfigurations-Palette

...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:.8rem;margin-bottom:1.2rem;">
    <div style="padding:.7rem .9rem;border:1px solid #d1d5db;border-radius:6px;background:#f9fafb;">
    ...
    <div style="padding:.7rem .9rem;border:1px solid #86efac;border-radius:6px;background:#f0fdf4;">
    ...
    <div style="padding:.7rem .9rem;border:1px solid {$this->errorBorderColor($errors)};border-radius:6px;background:{$this->errorBg($errors)};">
